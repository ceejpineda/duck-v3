...
class ChannelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create channel" do
    assert_difference("Channel.count") do
      post channels_url, params: { channel: { category_id: @channel.category_id, name: @channel.name } }
    end
  ...
  test "should update channel" do
    patch channel_url(@channel), params: { channel: { category_id: @channel.category_id, name: @channel.name } }

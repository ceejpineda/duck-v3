...
class VideoRoomsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create video_room" do
    assert_difference("VideoRoom.count") do
      post video_rooms_url, params: { video_room: { name: @video_room.name, vonage_session_id: @video_room.vonage_session_id } }
    end
  ...
  test "should update video_room" do
    patch video_room_url(@video_room), params: { video_room: { name: @video_room.name, vonage_session_id: @video_room.vonage_session_id } }
